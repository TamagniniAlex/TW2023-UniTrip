...
html=`<nav class="navbar bg-light fixed-bottom border-top border-2">
<div class="container">
  <div class="d-flex justify-content-around w-100 fs-3">
    <a href="#" class="text-center text-` + (focusOn == "feed" ? "dark" : "muted") + `"><i class="fa fa-home"></i></a>
    <a href="#" class="text-center text-` + (focusOn == "search" ? "dark" : "muted") + `"><i class="fa fa-search"></i></a>
